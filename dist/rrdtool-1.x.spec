...
%changelog
* Sun Sep 10 2023 Chuck Lane <lane@dhcooz.org>
- update 'patch' terminology
- add fix to Makefile to avoid permission complaints by 'strip'
-   see: https://stackoverflow.com/questions/30243997/permissions-error-related-to-stripping-when-creating-rpm-on-centos-from-source-c
